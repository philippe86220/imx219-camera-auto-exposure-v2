...
Exposure is limited to **4–3522** and the IMX219 analogue gain control to **0–232**. The exposure value sets how long the sensor collects light, measured in line times rather than milliseconds. Analogue gain amplifies the sensor signal, playing a role similar to raising ISO in photography, but its displayed value is a sensor gain setting, not an ISO rating.
